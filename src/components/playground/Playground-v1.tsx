...
export default function Playground({
  ...
  }, [config.description, config.settings, config.show_qr, localParticipant, name, roomState, voiceAssistant.agent, localVideoTrack, localMicTrack, themeColors, setUserSettings]);
